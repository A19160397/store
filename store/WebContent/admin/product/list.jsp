						...
						<td class="ta_01" align="center" bgColor="#f5fafe">
							<table cellspacing="0" cellpadding="1" rules="all"
								...
								<c:forEach items="${list }" var="p" varStatus="vs">
									...
									<!--下架 -->
											<td align="center" style="HEIGHT: 22px">
												<a href="${ pageContext.request.contextPath }/adminProduct?method=out&pid=${p.pid} " onclick="return del('下架')">
													下架
												</a>
											</td>
									<!--删除-->
											<td align="center" style="HEIGHT: 22px">
												<a href="${ pageContext.request.contextPath }/adminProduct?method=del&pid=${p.pid} " onclick="return del('删除')">
